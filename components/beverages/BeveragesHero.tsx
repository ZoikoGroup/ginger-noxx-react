...
export default function BeveragesHero() {
  return (
    <section className="w-full h-72 sm:h-80 md:h-[288px] relative bg-stone-950 overflow-hidden flex flex-col items-center justify-center text-center px-4">
      ...
      <div className="w-72 h-72 absolute left-[-40px] top-[54.05px] bg-orange-600/5 rounded-full blur-2xl pointer-events-none z-0" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold font-['Poppins'] leading-tight md:leading-[58.75px] tracking-tight mb-3 text-white">
          Ginger <span className="text-orange-600">Beverages</span>
        </h1>

        {/* Subtitle */}
        <p className="text-white text-sm sm:text-base font-normal font-['Poppins'] leading-7 max-w-[495px] mx-auto">
