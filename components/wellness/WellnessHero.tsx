...
export default function WellnessHero() {
  return (
    <section className="w-full h-60 sm:h-72 md:h-[240px] relative bg-stone-950 overflow-hidden flex flex-col items-center justify-center text-center px-4">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <Image
          ...
          alt="Ginger Wellness Background"
          fill
      ...
      <div className="w-72 h-72 absolute left-[-40px] top-[2.66px] bg-orange-600/5 rounded-full blur-2xl pointer-events-none z-0" />

      {/* Content */}
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
        {/* Category Pill Tag */}
        <div className="w-40 h-8 bg-orange-600/20 rounded-[999px] outline outline-1 outline-offset-[-1px] outline-orange-600/30 flex items-center justify-center mb-4 backdrop-blur-sm shadow-sm">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold font-['Poppins'] leading-tight md:leading-[58.75px] tracking-tight mb-3 text-white">
          Ginger <span className="text-orange-600">Wellness</span>
        </h1>

        {/* Subtitle */}
        <p className="text-white text-sm sm:text-base font-normal font-['Poppins'] leading-7 max-w-[465px] mx-auto">
